var shapes = {
  ...
  almostcircle: function semicircle(size) {
    return "\n  \tM " + size / 1.4 + ", " + size / 1.4 + "\n    m -" + size / 2 + ", 0\n    a " + size / 2 + "," + size / 2 + " 0 1 1 " + size/1.4 + ",0\n  ";
  }
};
var Progress$$1 = { render: function render() {
  var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('div', { staticClass: "vue-progress-path", class: _vm.cssClass, style: _vm.style }, [_c('svg', { attrs: { "width": _vm.finalWidth, "height": _vm.finalHeight, "viewBox": '0 0 ' + _vm.finalWidth + ' ' + _vm.finalHeight } }, [_c('g', { attrs: { "transform": 'translate(' + (_vm.finalWidth - _vm.size) / 2 + ', ' + (_vm.finalHeight - _vm.size) / 2 + ') rotate(' + _vm.finalRotation + ', ' + _vm.size / 2 + ', ' + _vm.size / 2 + ')' } }, [_c('g', { staticClass: "container" }, [!_vm.hideBackground ? _c('path', { staticClass: _vm.progress_bg, attrs: { "d": _vm.path } }) : _vm._e(), _c('path', { ref: "path", staticClass: _vm.background, attrs: { "d": _vm.path, "stroke-dasharray": _vm.finalDasharray + ' ' + _vm.finalDasharray, "stroke-dashoffset": 470-_vm.finalDashoffset } })])])])]);
}, staticRenderFns: [],
  name: 'Progress',
